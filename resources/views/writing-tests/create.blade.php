...
@section('title', 'Yangi Writing Test Yaratish')
    ...
    <div class="bg-white rounded-lg shadow-md">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Yangi Writing Test Yaratish</h1>
                    <p class="text-gray-600 mt-1">Writing test ma'lumotlarini kiriting</p>
                </div>
        ...
        <!-- Form -->
        <form action="{{ route('writing-tests.store') }}" method="POST" class="px-6 py-6">
            @csrf
            ...
            <div class="mb-6">
                ...
                <select name="app_test_id" id="app_test_id" required
                    ...
                    @foreach($appTests as $appTest)
                        <option value="{{ $appTest->id }}" {{ old('app_test_id') == $appTest->id ? 'selected' : '' }}>
                            {{ $appTest->title }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="mb-6">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="question_content" 
                              ...
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('question_content') border-red-500 @enderror">{{ old('question_content') }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="question_instructions" 
                              ...
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('question_instructions') border-red-500 @enderror">{{ old('question_instructions') }}</textarea>
            ...
            <div class="mb-6">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="answer_sample" 
                              ...
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('answer_sample') border-red-500 @enderror">{{ old('answer_sample') }}</textarea>
                    @error('answer_sample')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="answer_criteria" 
                              ...
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('answer_criteria') border-red-500 @enderror">{{ old('answer_criteria') }}</textarea>
            ...
            <div class="mb-6">
                <div class="bg-gray-50 rounded-lg p-4">
                    <div class="flex justify-between items-center mb-3">
                        <h4 class="text-sm font-medium text-gray-700">JSON Preview</h4>
                        <div class="space-x-2">
