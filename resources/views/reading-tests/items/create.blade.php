...
@section('title', 'Reading Test Item Yaratish')
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Reading Test Item Yaratish</h1>
                    <p class="text-gray-600 mt-1">{{ $readingTest->title }} uchun yangi item qo'shish</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('reading-tests.items.store', $readingTest) }}" method="POST">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <textarea id="content_body" 
                              ...
                              rows="8"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                              placeholder="Item mazmuni, matn, ko'rsatmalar va boshqalar...">{{ old('content_body') }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <div class="bg-gray-50 border border-gray-300 rounded-md p-3">
                        <pre id="json-preview" class="text-sm text-gray-700 whitespace-pre-wrap">
{
  "title": "",
  "body": "",
  "image_url": ""
