        ...
        <div class="tab-content">
            ...
            <div id="passage-tab" class="tab-pane active">
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="overflow-y-auto" style="height: calc(50vh - 100px);">
            ...
            <div id="questions-tab" class="tab-pane hidden">
                <form action="{{ route('reading.submit-answers', ['test' => $test->slug, 'attempt' => $attempt->id]) }}" method="POST" class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="overflow-y-auto questions-container" style="height: auto !important; min-height: 500px; max-height: none !important; display: block !important;">
                        <!-- Questions 1-13: True/False/Not Given -->
                        <div class="mb-10">
                            <div class="font-bold text-lg mb-4">Questions 1–7</div>
                            ...
                            <div class="space-y-2">
                                <div class="p-6 bg-gray-50 rounded-lg shadow-sm">
                                    ...
                                    <div class="answer-item">
                                        ...
                                        <div class="drop-zone" data-question="1">
                                            <input type="hidden" name="answers[1]" value="">
                                            <div class="placeholder">Drop your answer here</div>
                                        </div>
                                    </div>
                                    <div class="mt-2 mb-4">Sleep is a state that promotes growth and healing of the body's systems.</div>
                                </div>
                                ...
                                <div class="p-6 bg-gray-50 rounded-lg shadow-sm">
                                    ...
                                    <div class="answer-item">
                                        ...
                                        <div class="drop-zone" data-question="2">
                                            <input type="hidden" name="answers[2]" value="">
                                            <div class="placeholder">Drop your answer here</div>
                                        </div>
                                    </div>
                                    <div class="mt-2 mb-4">The energy conservation theory is not fully adequate as it only decreases metabolism by about 5-10%.</div>
                                </div>
                                
                                <div class="p-6 bg-gray-50 rounded-lg shadow-sm">
                                    <div class="mb-4">
                                        <span class="font-bold mr-2 text-lg">3.</span>
                                        According to the text, REM and NREM sleep:
                                    </div>
                                    <div class="flex flex-col space-y-3 pl-6">
                                        <label class="inline-flex items-center hover:bg-gray-100 p-2 rounded-md transition-colors">
                                            <input type="radio" name="answers[3]" value="A" class="form-radio h-5 w-5 text-blue-600">
                                            <span class="ml-3">A. occur only in mammals</span>
                                        </label>
                                        <label class="inline-flex items-center hover:bg-gray-100 p-2 rounded-md transition-colors">
                                            <input type="radio" name="answers[3]" value="B" class="form-radio h-5 w-5 text-blue-600">
                                            <span class="ml-3">B. have different physiological features</span>
                                        </label>
                                        <label class="inline-flex items-center hover:bg-gray-100 p-2 rounded-md transition-colors">
                                            <input type="radio" name="answers[3]" value="C" class="form-radio h-5 w-5 text-blue-600">
                                            <span class="ml-3">C. use the same amount of energy</span>
                                        </label>
                                        <label class="inline-flex items-center hover:bg-gray-100 p-2 rounded-md transition-colors">
                                            <input type="radio" name="answers[3]" value="D" class="form-radio h-5 w-5 text-blue-600">
                                            <span class="ml-3">D. are equally important for health</span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="p-6 bg-gray-50 rounded-lg shadow-sm">
                                    <div class="mb-4">
                                        <span class="font-bold mr-2 text-lg">4.</span>
                                        The restorative theory of sleep suggests that:
                                    </div>
                                    <div class="answer-item">
                                        <div class="answer-number">4</div>
                                        <div class="drop-zone" data-question="4">
                                            <input type="hidden" name="answers[4]" value="">
                                            <div class="placeholder">Drop your answer here</div>
                                        </div>
                                    </div>
                                    <div class="mt-2 mb-4">Sleep helps the body repair itself and restore vital functions.</div>
                                </div>
                                
                                <div class="p-6 bg-gray-50 rounded-lg shadow-sm">
                                    <div class="mb-4">
                                        <span class="font-bold mr-2 text-lg">5.</span>
                                        Sleep deprivation can lead to:
                                    </div>
                                    <div class="answer-item">
                                        <div class="answer-number">5</div>
                                        <div class="drop-zone" data-question="5">
                                            <input type="hidden" name="answers[5]" value="">
                                            <div class="placeholder">Drop your answer here</div>
                                        </div>
                                    </div>
                                    <div class="mt-2 mb-4">Sleep deprivation can lead to cognitive impairment and health issues.</div>
                                </div>
                                
                                <div class="p-6 bg-gray-50 rounded-lg shadow-sm">
                                    <div class="mb-4">
                                        <span class="font-bold mr-2 text-lg">6.</span>
                                        According to the text, dreaming occurs during:
                                    </div>
                                    <div class="answer-item">
                                        <div class="answer-number">6</div>
                                        <div class="drop-zone" data-question="6">
                                            <input type="hidden" name="answers[6]" value="">
                                            <div class="placeholder">Drop your answer here</div>
                                        </div>
                                    </div>
                                    <div class="mt-2 mb-4">Dreaming primarily occurs during REM sleep.</div>
                                </div>
                                
                                <div class="p-6 bg-gray-50 rounded-lg shadow-sm">
                                    <div class="mb-4">
                                        <span class="font-bold mr-2 text-lg">7.</span>
                                        The text states that sleep patterns:
                                    </div>
                                    <div class="answer-item">
                                        <div class="answer-number">7</div>
                                        <div class="drop-zone" data-question="7">
                                            <input type="hidden" name="answers[7]" value="">
                                            <div class="placeholder">Drop your answer here</div>
                                        </div>
                                    </div>
                                    <div class="mt-2 mb-4">Sleep patterns vary across different species and age groups.</div>
                                </div>
                                
                                <!-- Questions 8-13: Matching headings -->
                                <div class="mb-10 mt-10">
                                    <div class="font-bold text-lg mb-4">Questions 8–13</div>
                                    <div class="mb-6 text-gray-700">
                                        Match each statement with the correct paragraph (A-F). Write the correct letter A-F in boxes 8-13 on your answer sheet.
                                    </div>
                                    ...
                                    <div class="space-y-2">
                                        <div class="p-6 bg-gray-50 rounded-lg shadow-sm">
                                            <div class="mb-4">
                                                <span class="font-bold mr-2 text-lg">8.</span>
                                                A description of how sleep affects memory formation
                                            </div>
                                            <div class="answer-item">
                                                <div class="answer-number">8</div>
                                                <div class="drop-zone" data-question="8">
                                                    <input type="hidden" name="answers[8]" value="">
                                                    <div class="placeholder">Drop your answer here</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-6 bg-gray-50 rounded-lg shadow-sm">
                                            <div class="mb-4">
                                                <span class="font-bold mr-2 text-lg">9.</span>
                                                An explanation of why we need regular sleep cycles
                                            </div>
                                            <div class="answer-item">
                                                <div class="answer-number">9</div>
                                                <div class="drop-zone" data-question="9">
                                                    <input type="hidden" name="answers[9]" value="">
                                                    <div class="placeholder">Drop your answer here</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-6 bg-gray-50 rounded-lg shadow-sm">
                                            <div class="mb-4">
                                                <span class="font-bold mr-2 text-lg">10.</span>
                                                A comparison between human and animal sleep patterns
                                            </div>
                                            <div class="answer-item">
                                                <div class="answer-number">10</div>
                                                <div class="drop-zone" data-question="10">
                                                    <input type="hidden" name="answers[10]" value="">
                                                    <div class="placeholder">Drop your answer here</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-6 bg-gray-50 rounded-lg shadow-sm">
                                            <div class="mb-4">
                                                <span class="font-bold mr-2 text-lg">11.</span>
                                                The relationship between sleep quality and mental health
                                            </div>
                                            <div class="answer-item">
                                                <div class="answer-number">11</div>
                                                <div class="drop-zone" data-question="11">
                                                    <input type="hidden" name="answers[11]" value="">
                                                    <div class="placeholder">Drop your answer here</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-6 bg-gray-50 rounded-lg shadow-sm">
                                            <div class="mb-4">
                                                <span class="font-bold mr-2 text-lg">12.</span>
                                                How modern technology affects our sleep patterns
                                            </div>
                                            <div class="answer-item">
                                                <div class="answer-number">12</div>
                                                <div class="drop-zone" data-question="12">
                                                    <input type="hidden" name="answers[12]" value="">
                                                    <div class="placeholder">Drop your answer here</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-6 bg-gray-50 rounded-lg shadow-sm">
                                            <div class="mb-4">
                                                ...
                                                The evolution of sleep research over time
                                            </div>
                                            <div class="answer-item">
                                                <div class="answer-number">13</div>
                                                <div class="drop-zone" data-question="13">
                                                    <input type="hidden" name="answers[13]" value="">
                                                    <div class="placeholder">Drop your answer here</div>
                                                </div>
                                            </div>
                                        </div>
