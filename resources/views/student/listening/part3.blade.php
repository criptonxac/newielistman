    ...
    <div class="main-content">
        ...
        <div class="question-panel">
            ...
            <div class="question-block">
                <div class="question">
                    <p><strong>21. According to the speakers, what is the main purpose of their research project?</strong></p>
                    <div class="options">
                        <label class="option">
                            <input type="radio" name="q21" value="A" data-question="21">
                            <span>A. To analyze the economic impact of tourism</span>
                        </label>
                        <label class="option">
                            <input type="radio" name="q21" value="B" data-question="21">
                            <span>B. To study environmental conservation methods</span>
                        </label>
                        <label class="option">
                            <input type="radio" name="q21" value="C" data-question="21">
                            <span>C. To examine the relationship between tourism and conservation</span>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="question-block">
                <div class="question">
                    <p><strong>22. What does Professor Wilson suggest about the research methodology?</strong></p>
                    <div class="options">
                        <label class="option">
                            <input type="radio" name="q22" value="A" data-question="22">
                            <span>A. It should focus primarily on quantitative data</span>
                        </label>
                        <label class="option">
                            <input type="radio" name="q22" value="B" data-question="22">
                            <span>B. It should include both interviews and surveys</span>
                        </label>
                        <label class="option">
                            <input type="radio" name="q22" value="C" data-question="22">
                            <span>C. It should be limited to observational studies</span>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="question-block">
                <div class="question">
                    <p><strong>23. What problem do the students identify with their initial research plan?</strong></p>
                    <div class="options">
                        <label class="option">
                            <input type="radio" name="q23" value="A" data-question="23">
                            <span>A. The sample size is too small</span>
                        </label>
                        <label class="option">
                            <input type="radio" name="q23" value="B" data-question="23">
                            <span>B. The timeframe is too limited</span>
                        </label>
                        <label class="option">
