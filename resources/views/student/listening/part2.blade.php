...
@section('title', $test->title . ' - Listening Part 2')
@section('description', 'IELTS Listening Test - Part 2')
...
<div class="container">
    ...
    <div class="header">
        <div>
            <h1>{{ $test->title }}</h1>
            <div>Part 2: Questions 11-20</div>
        </div>
    ...
    <div class="main-content">
        ...
        <div class="question-panel">
            ...
            <div class="question-instruction">
                ...
                <strong>COMMUNITY CENTRE SURVEY</strong>
            </div>
            ...
            <div class="question-block">
                <div class="text-passage">
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            <td>Address:</td>
                            <td><input type="text" class="answer-input" data-question="11" placeholder="11"> Avenue</td>
                        </tr>
                        <tr>
                            <td>Occupation:</td>
                            <td><input type="text" class="answer-input" data-question="12" placeholder="12"></td>
                        </tr>
                        <tr>
                            <td>Age group:</td>
                            <td><input type="text" class="answer-input" data-question="13" placeholder="13"></td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <div class="question-block">
                <div class="text-passage">
                    <strong>Current Use of Centre</strong><br>
                    <table class="form-table">
                        <tr>
                            <td>Frequency of visits:</td>
                            <td><input type="text" class="answer-input" data-question="14" placeholder="14"></td>
                        </tr>
                        <tr>
                            <td>Most frequent activity:</td>
                            <td><input type="text" class="answer-input" data-question="15" placeholder="15"></td>
                        </tr>
                        <tr>
                            <td>Time spent at centre:</td>
                            <td><input type="text" class="answer-input" data-question="16" placeholder="16"> per visit</td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <div class="question-block">
                <div class="text-passage">
                    ...
                    <table class="form-table">
                        <tr>
                            <td>Facilities:</td>
                            <td>Need more <input type="text" class="answer-input" data-question="17" placeholder="17"></td>
                        </tr>
                        <tr>
                            <td>Classes:</td>
                            <td>Would like <input type="text" class="answer-input" data-question="18" placeholder="18"> classes</td>
                        </tr>
                        <tr>
                            <td>Opening hours:</td>
                            <td>Should open at <input type="text" class="answer-input" data-question="19" placeholder="19"> on weekends</td>
                        </tr>
                        <tr>
                            <td>Other comments:</td>
                            <td>Café should offer <input type="text" class="answer-input" data-question="20" placeholder="20"></td>
                        </tr>
                    </table>
                </div>
            </div>
        ...
        <div class="audio-panel">
            <div class="audio-player">
                ...
                <audio id="audioPlayer" controls style="width: 100%; margin-top: 1rem;">
                    <source src="{{ asset('audio/listening-part2.mp3') }}" type="audio/mpeg">
            ...
            <div style="background: white; border-radius: 8px; padding: 1rem; margin-top: 1rem;">
                ...
                <ul style="margin-top: 0.5rem; padding-left: 1.5rem; font-size: 0.9rem;">
                    ...
                    <li>NO MORE THAN THREE WORDS AND/OR A NUMBER per answer</li>
                </ul>
            </div>
    ...
    <div class="progress-section">
        <div class="flex justify-between items-center w-full py-4">
            <div class="flex items-center space-x-4">
                <a href="{{ route('listening.part1', ['test' => $test->slug, 'attempt' => $attempt->id]) }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 py-2 px-6 rounded-lg font-medium flex items-center">
                    <i class="fas fa-arrow-left mr-2"></i> Back to Part 1
                </a>
            </div>
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="{{ route('listening.part3', ['test' => $test->slug, 'attempt' => $attempt->id]) }}" class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-6 rounded-lg font-bold flex items-center">
                    Continue to Part 3 <i class="fas fa-arrow-right ml-2"></i>
                </a>
            </div>
        </div>
    </div>
