...
Route::middleware(['auth'])->prefix('test-management')->name('test-management.')->group(function () {
    Route::middleware([\App\Http\Middleware\CheckRole::class.':admin,teacher'])->group(function () {
...
Route::prefix('teacher')->name('teacher.')->middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/export/user/{user}', [App\Http\Controllers\TeacherController::class, 'exportUser'])->name('export.user');
});
